...
<div class="auth-container">
    <div class="auth-card">
        ...
        <div style="text-align:center;margin-top:1.25rem;">
            <a href="<?php echo e(route('login')); ?>" style="font-size:12px;color:var(--ibex-accent);text-decoration:none;">
...
<?php /**PATH C:\Users\my pc\Desktop\IBEX1\ibex-ims\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>