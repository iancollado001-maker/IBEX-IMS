            ...
            <form id="assetForm" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="ibex-input form-control" id="date_added"
                        name="date_added" value="<?php echo e(date('Y-m-d')); ?>" required>
                </div>
        ...
        <div class="dashboard-top">
            <div class="stats-section">
                <div class="stats-5">
                    <div class="stat-card total">
                        ...
                        <div class="stat-value" id="stat-total"><?php echo e($stats['total']); ?></div>
                        <div class="stat-label">No. of Assets</div>
                    </div>
                    <div class="stat-card defective">
                        <div class="stat-icon"><i class="bi bi-exclamation-triangle"></i></div>
                        <div class="stat-value" id="stat-defective"><?php echo e($stats['defective']); ?></div>
                        <div class="stat-label">Defective</div>
                    </div>
                    <div class="stat-card deployed">
                        <div class="stat-icon"><i class="bi bi-send-check"></i></div>
                        <div class="stat-value" id="stat-deployed"><?php echo e($stats['deployed']); ?></div>
                        <div class="stat-label">Deployed</div>
                    </div>
                    <div class="stat-card available">
                        <div class="stat-icon"><i class="bi bi-check-circle"></i></div>
                        <div class="stat-value" id="stat-available"><?php echo e($stats['available']); ?></div>
                        <div class="stat-label">Available</div>
                    </div>
                    <div class="stat-card spare">
                        <div class="stat-icon"><i class="bi bi-archive"></i></div>
                        <div class="stat-value" id="stat-spare"><?php echo e($stats['spare']); ?></div>
            ...
            <div class="monthly-panel">
                ...
                <div class="monthly-stat added-stat">
                    ...
                    <div class="monthly-stat-val" id="monthly-added"><?php echo e($monthly['added']); ?></div>
                </div>
                <div class="monthly-stat removed-stat">
                    <div class="monthly-stat-label">
                        <i class="bi bi-arrow-down-circle-fill"></i> Removed Assets
                    </div>
                    <div class="monthly-stat-val" id="monthly-removed"><?php echo e($monthly['removed']); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="ibex-table-panel">
            <div class="table-header">
                ...
                <div class="d-flex gap-2 align-items-center flex-wrap">
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>" class="btn-ibex btn-ibex-ghost btn-ibex-sm">
            ...
            <div class="table-responsive">
                <table id="assetsTable" class="table table-hover mb-0" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr data-id="<?php echo e($asset->id); ?>"
                            data-serial="<?php echo e($asset->serial_number); ?>"
                            data-tag="<?php echo e($asset->asset_tag); ?>"
                            data-category="<?php echo e($asset->category_id); ?>"
                            data-brand="<?php echo e($asset->brand_id); ?>"
                            data-status="<?php echo e($asset->status); ?>"
                            data-date="<?php echo e($asset->date_added); ?>">
                            <td><span class="row-number"><?php echo e($index + 1); ?></span></td>
                            ...
                            <td>
                                <button class="btn-ibex btn-ibex-ghost btn-ibex-sm editBtn"
                                    data-id="<?php echo e($asset->id); ?>" title="Edit">
            ...
            <div class="table-footer">
                <div style="font-size:12px;color:var(--ibex-text-muted);">
                    Showing <?php echo e($assets->count()); ?> of <?php echo e($assets->total()); ?> assets
                </div>
                <div><?php echo e($assets->links('components.pagination')); ?></div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="manage-list" id="categoryList">
                    ...
                    <div class="manage-list-item" id="cat-row-<?php echo e($cat->id); ?>">
                        <span class="manage-item-name"><?php echo e($cat->category_name); ?></span>
                        <button class="btn-ibex btn-ibex-danger btn-ibex-sm deleteCategoryBtn"
                            data-id="<?php echo e($cat->id); ?>" data-name="<?php echo e($cat->category_name); ?>"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="manage-list" id="brandList">
                    ...
                    <div class="manage-list-item" id="brand-row-<?php echo e($brand->id); ?>">
                        <span class="manage-item-name"><?php echo e($brand->brand_name); ?></span>
                        <button class="btn-ibex btn-ibex-danger btn-ibex-sm deleteBrandBtn"
                            data-id="<?php echo e($brand->id); ?>" data-name="<?php echo e($brand->brand_name); ?>"
                            title="Delete brand">
                            <i class="bi bi-trash3"></i>
                        </button>
                    </div>
...
const ASSETS_URL    = '<?php echo e(route("inventory.store")); ?>';
const UPDATE_BASE   = '<?php echo e(url("inventory")); ?>';
const MONTHLY_URL   = '<?php echo e(route("inventory.monthly")); ?>';
const CATEGORY_URL  = '<?php echo e(route("categories.store")); ?>';
const BRAND_URL     = '<?php echo e(route("brands.store")); ?>';
const CAT_DEL_BASE  = '<?php echo e(url("categories")); ?>';
const BRAND_DEL_BASE= '<?php echo e(url("brands")); ?>';
</script>
<script src="<?php echo e(asset('js/inventory.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\my pc\Desktop\IBEX1\ibex-ims\resources\views/inventory/index.blade.php ENDPATH**/ ?>